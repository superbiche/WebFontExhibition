...
class Font {
     ...
     * Builds a simple CSS @font-face declaration that will work only in some browsers,
     *  depending on file formats available and sets the font as default for body inside a <script> block
     * @param $output can be indent or anything else actually.
     *  Indent inserts line breaks for a clean css file for development,
     *  'blop' returns condensed data (for json encoding etc)
     * @param weight(string, optional, default : 'normal') : the weight of the font file
     * @param style(string, optional, default : 'normal') : the style of the font file
     * @param variant(string, optional, default : 'normal') : the variant of the font file (normal / small-caps!)
     ...
     * This method checks for the available format (with priority to .otf as it's an open standard)
     *  and returns the right information for the CSS Fallback @font-face
     * @return array : an array containing the file extension ['extension']
     *  and format ['format'] strings to use inside the @font-face declaration
      */
    protected function getCSSFallbackFormat() {
